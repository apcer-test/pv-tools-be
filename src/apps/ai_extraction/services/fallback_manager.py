...
class FallbackManager:
    ...
    async def execute_with_agent(self,
        ...
        self.logger.info(f"Executing fallback chain - RequestID: {request_id}, Agent: {agent.code}, Steps: {len(steps)}")
        ...
        for step_index, step in enumerate(steps):
            ...
            try:
                ...
                if step.retry_delay_ms > 0:
                    self.logger.info(f"Waiting {step.retry_delay_ms}ms before next step - RequestID: {request_id}, Agent: {agent.code}")
