...
async def extract_document_endpoint(
    ...
    doc_type: Annotated[
        DocType,
        Form(..., description="Document type (CIOMS, IRMS, AER, LAB_REPORT, UNKNOWN)"),
    ],
    ...
    try:
        ...
        logger.info(
            f"Document extraction completed successfully - RequestID: {request_id}, Status: {result.status}"
        )
