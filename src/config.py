...
class Settings(BaseSettings):
    ...
    GENERATE_CODE_REDIRECT_URL: Optional[str] = Field(None, alias="GENERATE_CODE_REDIRECT_URL")
    ...
    ACTIVATE_WORKER_SENTRY: Optional[bool] = Field(False, alias="ACTIVATE_WORKER_SENTRY")
